...
def make_umi_image_processor(in_res, out_res, no_mirror: bool, mirror_swap: bool, fisheye_converter=None):
    ...
    def process(rgb_img: np.ndarray, tag_detection) -> np.ndarray:
